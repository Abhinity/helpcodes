...
public class RecipeVideo extends YouTubeBaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mediaControls == null) {
            ...
            mediaControls = new MediaController(RecipeVideo.this);
            mediaControls.setAnchorView(youTubeView);
        }

        playerStateChangeListener = new MyPlayerStateChangeListener();
        playbackEventListener = new MyPlaybackEventListener();
        //youTubeView(mediaControls);
